...
async def upload_audio(
    ...
    logger.info("audio upload endpoint called user_id=%s filename=%s content_type=%s", user_id, file.filename, file.content_type)
...
async def upload_audio_wav(
    ...
    logger.info("audio upload-audio endpoint called filename=%s content_type=%s", file.filename, file.content_type)
